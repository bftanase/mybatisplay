...
This module allows you to use MyBatis persistence framework with play. This version no longer includes MyBatis source, since the issue #530
has been fixed and the previous patch is not necessary anymore.
