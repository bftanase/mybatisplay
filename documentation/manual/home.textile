...
p(note). This module allows you to use MyBatis persistence framework with play. Included is MyBatis version 3.0.6
...
p(note). There is a sample in  @samples-and-tests/mybatisapp@ folder.

p(note). @cd@ to that directory and run:
